...
// Save to disk
await client.saveDatabase('mydb');`))),v({class:e.section},H({class:e.pageH2},"5. What's Next?"),w({class:e.pageUl},o({class:e.pageLi},u("Documentation")," - Read detailed API documentation"),o({class:e.pageLi},u("Usage Examples")," - Explore advanced usage patterns"),o({class:e.pageLi},u("CLI Reference")," - Learn command-line interface"),o({class:e.pageLi},u("Authentication")," - Set up secure connections"),o({class:e.pageLi},u("Real-Time Sync")," - Enable WebSocket synchronization"))));var we=()=>v(k({class:e.pageH1},"Documentation"),T({class:e.pageP},"Welcome to the ScriptDB documentation."),v({class:e.section},H({class:e.pageH2},"What is ScriptDB?"),T({class:e.pageP},"ScriptDB is a high-performance in-memory database with JavaScript-based querying and real-time synchronization capabilities. It provides sub-millisecond query response times and supports both browser and Node.js environments.")),v({class:e.section},H({class:e.pageH2},"Core Concepts"),P({class:e.pageH3},"In-Memory Database"),T({class:e.pageP},"ScriptDB stores data in memory for ultra-fast access:"),w({class:e.pageUl},o({class:e.pageLi},"Sub-millisecond query response times"),o({class:e.pageLi},"JavaScript-based querying language"),o({class:e.pageLi},"Multiple isolated databases"),o({class:e.pageLi},"Persistent snapshots to disk")),P({class:e.pageH3},"Real-Time Synchronization"),T({class:e.pageP},"WebSocket support for real-time updates:"),w({class:e.pageUl},o({class:e.pageLi},"Browser client with WebSocket connection"),o({class:e.pageLi},"Node.js client with TCP connection"),o({class:e.pageLi},"Automatic reconnection with exponential backoff"),o({class:e.pageLi},"Request queue management for high concurrency")),P({class:e.pageH3},"Cross-Platform Support"),T({class:e.pageP},"ScriptDB works seamlessly on:"),w({class:e.pageUl},o({class:e.pageLi},u("Windows")," (x64, x86)"),o({class:e.pageLi},u("Linux")," (x64, arm64, with glibc or musl)"),o({class:e.pageLi},u("macOS")," (x64, arm64/Apple Silicon)"))),v({class:e.section},H({class:e.pageH2},"Server Architecture"),P({class:e.pageH3},"Protocol"),T({class:e.pageP},"ScriptDB uses a custom protocol over TCP and WebSocket:"),w({class:e.pageUl},o({class:e.pageLi},"Connection URI: ",i({class:e.pageCode},"scriptdb://host:port/database")),o({class:e.pageLi},"WebSocket port: TCP port + 1"),o({class:e.pageLi},"JSON message format with optional HMAC signing"),o({class:e.pageLi},"Token-based authentication")),P({class:e.pageH3},"Installation Directories"),T({class:e.pageP},"Default installation locations:"),w({class:e.pageUl},o({class:e.pageLi},u("Windows: "),i({class:e.pageCode},"%USERPROFILE%\\.scriptdb")),o({class:e.pageLi},u("Linux/macOS: "),i({class:e.pageCode},"~/.scriptdb")))),v({class:e.section},H({class:e.pageH2},"Environment Variables"),w({class:e.pageUl},o({class:e.pageLi},u("SCRIPTDB_PORT")," - Server port (default: 1234)"),o({class:e.pageLi},u("SCRIPTDB_HOST")," - Server host (default: 0.0.0.0)"),o({class:e.pageLi},u("SCRIPTDB_DATA_DIR")," - Data directory path"),o({class:e.pageLi},u("SCRIPTDB_LOG_LEVEL")," - Logging level (debug, info, warn, error)"))),v({class:e.section},H({class:e.pageH2},"Key Features"),w({class:e.pageUl},o({class:e.pageLi},u("High Performance")," - In-memory storage with sub-millisecond queries"),o({class:e.pageLi},u("WebSocket Support")," - Real-time synchronization for browsers"),o({class:e.pageLi},u("Persistent Storage")," - Save databases to disk at any time"),o({class:e.pageLi},u("Authentication")," - Built-in username/password with token sessions"),o({class:e.pageLi},u("HMAC Signing")," - Optional message signing for enhanced security"),o({class:e.pageLi},u("JavaScript Querying")," - Use JavaScript for powerful data manipulation"),o({class:e.pageLi},u("Multiple Databases")," - Manage multiple isolated database contexts"),o({class:e.pageLi},u("Auto-Reconnect")," - Automatic reconnection with exponential backoff"))),v({class:e.section},H({class:e.pageH2},"Client Libraries"),T({class:e.pageP},"ScriptDB provides official client libraries for different environments:"),w({class:e.pageUl},o({class:e.pageLi},u(U({href:"#/api",onclick:t=>{t.preventDefault(),window.location.hash="#/api"}},"@scriptdb/browser-client"))," - WebSocket client for browser applications"),o({class:e.pageLi},u(U({href:"#/api",onclick:t=>{t.preventDefault(),window.location.hash="#/api"}},"@scriptdb/client"))," - TCP client for Node.js applications")),T({class:e.pageP},"Visit the ",U({href:"#/api",onclick:t=>{t.preventDefault(),window.location.hash="#/api"}},"API Documentation")," page for detailed reference and examples.")),v({class:e.section},H({class:e.pageH2},"Quick Example"),T({class:e.pageP},"Get started with ScriptDB in just a few lines:"),S({class:e.pagePre},i({class:e.pageCode},`import ScriptDBClient from '@scriptdb/browser-client';
...
// Save to disk
await client.saveDatabase('mydb');`))));var Le=()=>v(k({class:e.pageH1},"Usage"),T({class:e.pageP},"Learn how to use ScriptDB effectively with practical examples."),v({class:e.section},H({class:e.pageH2},"Server Management"),P({class:e.pageH3},"Starting ScriptDB"),S({class:e.pagePre},i({class:e.pageCode},`# Start the server (default port: 1234)
scriptdb start
...
# Start server
scriptdb start`)),P({class:e.pageH3},"Next Steps"),w({class:e.pageUl},o({class:e.pageLi},"Read the ",u("Quick Start")," guide"),o({class:e.pageLi},"Explore the ",u("API Documentation")," for client libraries"),o({class:e.pageLi},"Check ",u("Usage")," examples"))));var Pe=()=>{let t=j("browser");return v(k({class:e.pageH1},"API Documentation"),T({class:e.pageP},"Complete API reference for ScriptDB client libraries."),v({class:e.tabs},E(t,s=>Y({class:s==="browser"?e.tabActive:e.tab,style:"cursor: pointer; padding: 0.75rem 1.5rem;",onclick:()=>t.value="browser"},"@scriptdb/browser-client")),E(t,s=>Y({class:s==="node"?e.tabActive:e.tab,style:"cursor: pointer; padding: 0.75rem 1.5rem;",onclick:()=>t.value="node"},"@scriptdb/client"))),v({class:e.tabContent},E(t,s=>s==="browser"?Xe():et())))},Xe=()=>v(v({class:e.section},H({class:e.pageH2},"Installation"),S({class:e.pagePre},i({class:e.pageCode},"npm install @scriptdb/browser-client")),T({class:e.pageP},"Or use CDN:"),S({class:e.pagePre},i({class:e.pageCode},`<script type="module">
...
`)}inject(t){let s=this.render(),a=document.createElement("style");return t&&(a.id=t),a.textContent=s,document.head.appendChild(a),a}clear(){this.variables=[],this.rules=[],this.mediaRules=[],this.keyframes=[],this.fontFaces=[],this.imports=[],this.containerRules=[],this.supportsRules=[],this.layerRules=[],this.t=[]}},it=new oe,{addVar:br,var:yr,addTag:vr,addClass:Cr,addId:Sr,addPseudoClass:wr,addPseudoElement:Lr,addAttribute:Tr,attrEquals:Pr,attrContainsWord:$r,attrStartsWith:Hr,attrEndsWith:Rr,attrContains:xr,descendant:Nr,child:kr,adjacentSibling:Dr,generalSibling:Er,multiple:Ar,addName:Mr,nesting:Ur,keyframe:Or,keyframeFromTo:Ir,fontFace:Fr,import:Br,media:Vr,mediaScreen:Wr,mediaPrint:jr,mediaMinWidth:qr,mediaMaxWidth:Jr,mediaDark:zr,mediaLight:_r,mediaReducedMotion:Gr,container:Qr,addContainer:Kr,supports:Yr,layerOrder:Zr,layer:Xr,add:ei,important:ti,render:si,inject:ai,clear:ni}=it,Q=typeof document<"u";function ot(t){return t.charAt(0).toUpperCase()+t.slice(1)}function A(t){return Q&&t?t.bind(N):void 0}function Ne(t,s,a){t.forEach(n=>{let c=s+ot(n);a[c]=ce(n)})}var ce=t=>function(s,...a){if(!arguments.length)return{tagName:t,props:{},children:[]};let n=s&&typeof s=="object"&&"value"in s&&"subscribe"in s,c=s&&typeof s=="object"&&"tagName"in s,p=typeof s!="object"||Array.isArray(s)||s===null||n||c,r=p?{}:s,d=p?[s,...a]:a;if(!d.length)return{tagName:t,props:r,children:[]};let b=[];for(let g=0,f=d.length;g<f;g++){let l=d[g];if(!(l==null||l===!1))if(Array.isArray(l))for(let C=0,y=l.length;C<y;C++){let m=l[C];m!=null&&m!==!1&&b.push(m)}else b.push(l)}return{tagName:t,props:r,children:b}},ct=["html","head","body","title","base","link","meta","style","address","article","aside","footer","header","h1","h2","h3","h4","h5","h6","main","nav","section","blockquote","dd","div","dl","dt","figcaption","figure","hr","li","ol","p","pre","ul","a","abbr","b","bdi","bdo","br","cite","code","data","dfn","em","i","kbd","mark","q","rp","rt","ruby","s","samp","small","span","strong","sub","sup","time","u","wbr","area","audio","img","map","track","video","embed","iframe","object","param","picture","portal","source","canvas","noscript","script","del","ins","caption","col","colgroup","table","tbody","td","tfoot","th","thead","tr","button","datalist","fieldset","form","input","label","legend","meter","optgroup","option","output","progress","select","textarea","details","dialog","menu","summary","slot","template"],lt=["svg","circle","rect","path","line","polyline","polygon","ellipse","g","text","tspan","defs","linearGradient","radialGradient","stop","pattern","mask","clipPath","use","symbol","marker","image","foreignObject","animate","animateTransform","animateMotion","set","filter","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feFlood","feGaussianBlur","feMorphology","feOffset","feSpecularLighting","feTile","feTurbulence"],pt=["math","mi","mn","mo","ms","mtext","mrow","mfrac","msqrt","mroot","msub","msup"],J={};ct.forEach(t=>{J[t]=ce(t)});Ne(lt,"svg",J);Ne(pt,"math",J);J.varElement=ce("var");var{html:ri,head:ii,body:oi,title:ci,base:li,link:pi,meta:di,style:ui,address:gi,article:hi,aside:mi,footer:ke,header:fi,h1:bi,h2:yi,h3:vi,h4:Ci,h5:Si,h6:wi,main:Li,nav:Ti,section:Pi,blockquote:$i,dd:Hi,div:De,dl:Ri,dt:xi,figcaption:Ni,figure:ki,hr:Di,li:Ei,ol:Ai,p:Ee,pre:Mi,ul:Ui,a:Oi,abbr:Ii,b:Fi,bdi:Bi,bdo:Vi,br:Wi,cite:ji,code:qi,data:Ji,dfn:zi,em:_i,i:Gi,kbd:Qi,mark:Ki,q:Yi,rp:Zi,rt:Xi,ruby:eo,s:to,samp:so,small:ao,span:no,strong:ro,sub:io,sup:oo,time:co,u:lo,wbr:po,area:uo,audio:go,img:ho,map:mo,track:fo,video:bo,embed:yo,iframe:vo,object:Co,param:So,picture:wo,portal:Lo,source:To,canvas:Po,noscript:$o,script:Ho,del:Ro,ins:xo,caption:No,col:ko,colgroup:Do,table:Eo,tbody:Ao,td:Mo,tfoot:Uo,th:Oo,thead:Io,tr:Fo,button:Bo,datalist:Vo,fieldset:Wo,form:jo,input:qo,label:Jo,legend:zo,meter:_o,optgroup:Go,option:Qo,output:Ko,progress:Yo,select:Zo,textarea:Xo,details:ec,dialog:tc,menu:sc,summary:ac,slot:nc,template:rc,svgSvg:ic,svgCircle:oc,svgRect:cc,svgPath:lc,svgLine:pc,svgPolyline:dc,svgPolygon:uc,svgEllipse:gc,svgG:hc,svgText:mc,svgTspan:fc,svgDefs:bc,svgLinearGradient:yc,svgRadialGradient:vc,svgStop:Cc,svgPattern:Sc,svgMask:wc,svgClipPath:Lc,svgUse:Tc,svgSymbol:Pc,svgMarker:$c,svgImage:Hc,svgForeignObject:Rc,svgAnimate:xc,svgAnimateTransform:Nc,svgAnimateMotion:kc,svgSet:Dc,svgFilter:Ec,svgFeBlend:Ac,svgFeColorMatrix:Mc,svgFeComponentTransfer:Uc,svgFeComposite:Oc,svgFeConvolveMatrix:Ic,svgFeDiffuseLighting:Fc,svgFeDisplacementMap:Bc,svgFeFlood:Vc,svgFeGaussianBlur:Wc,svgFeMorphology:jc,svgFeOffset:qc,svgFeSpecularLighting:Jc,svgFeTile:zc,svgFeTurbulence:_c,mathMath:Gc,mathMi:Qc,mathMn:Kc,mathMo:Yc,mathMs:Zc,mathMtext:Xc,mathMrow:el,mathMfrac:tl,mathMsqrt:sl,mathMroot:al,mathMsub:nl,mathMsup:rl,varElement:il}=J;var N=Q?document:void 0,ol=A(N?.querySelector),cl=A(N?.querySelectorAll),ll=A(N?.createElement),pl=Q?N.createElementNS.bind(N,"http://www.w3.org/2000/svg"):void 0,dl=Q?N.createElementNS.bind(N,"http://www.w3.org/1998/Math/MathML"):void 0,ul=A(N?.createDocumentFragment),gl=A(N?.createTextNode),hl=A(N?.createComment),ml=A(N?.getElementById),fl=A(N?.getElementsByClassName),bl=A(N?.getElementsByTagName),yl=A(N?.getElementsByName);var dt=class{constructor(){this.enabled=!1,this.ws=null,this.acceptCallbacks=[],this.disposeCallbacks=[],this.declined=!1,!(typeof window>"u")&&this.connect()}connect(){let t=window.location.protocol==="https:"?"wss:":"ws:",s=window.location.hostname,a=window.location.port||"3000";this.ws=new WebSocket(`${t}//${s}:${a}`),this.ws.onopen=()=>{this.enabled=!0,console.log("[Elit HMR] Connected \u2713")},this.ws.onmessage=n=>{try{let c=JSON.parse(n.data);this.handleMessage(c)}catch(c){console.error("[Elit HMR] Error parsing message:",c)}},this.ws.onclose=()=>{this.enabled=!1,console.log("[Elit HMR] Disconnected - Attempting reconnect..."),setTimeout(()=>this.reload(),1e3)},this.ws.onerror=n=>{console.error("[Elit HMR] WebSocket error:",n)}}handleMessage(t){switch(t.type){case"connected":console.log("[Elit HMR] Ready");break;case"update":if(console.log(`[Elit HMR] Update detected: ${t.path}`),this.declined){this.reload();return}this.disposeCallbacks.forEach(s=>s()),this.disposeCallbacks=[],this.acceptCallbacks.length>0?this.acceptCallbacks.forEach(s=>s()):this.reload();break;case"reload":console.log("[Elit HMR] Full reload requested"),this.reload();break;case"error":console.error("[Elit HMR] Server error:",t.error);break}}reload(){window.location.reload()}accept(t){t&&this.acceptCallbacks.push(t),this.declined=!1}decline(){this.declined=!0}dispose(t){this.disposeCallbacks.push(t)}},ut=new dt;typeof window<"u"&&(window.n=ut);var Ae=()=>ke({class:e.footer},De({class:e.container},Ee("\xA9 2025 ScriptDB. MIT License.")));var R=new oe,Me=!1,Ue=()=>{if(Me)return;Me=!0;let t=document.createElement("style");t.textContent=`
    * {
      margin: 0;
      padding: 0;
